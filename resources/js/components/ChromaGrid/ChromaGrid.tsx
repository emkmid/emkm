...
const ChromaGrid: React.FC<ChromaGridProps> = ({ items, className = '', radius = 300, damping = 0.45, fadeOut = 0.6, ease = 'power3.out' }) => {
    ...
    return (
        <div
            ...
            className={`relative flex h-full w-full flex-wrap items-start justify-center gap-3 ${className}`}
            style={
                {
                    '--r': `${radius}px`,
                    '--x': '50%',
