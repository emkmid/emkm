...
export default function Welcome() {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-800">
            ...
            >
                <div className="container mx-auto flex items-center justify-between px-6 py-4">
                    ...
                    <nav className="hidden items-center space-x-8 lg:flex">
                        {['Home', 'About', 'Pricing', 'Team', 'Contact', 'Blog'].map((item) => (
                            <a
                                key={item}
                ...
                <div className="container mx-auto flex flex-col gap-5 px-5 md:flex-row md:items-center">
                    <div className="fade-down flex-1 text-center md:text-start">
                        ...
                        <div className="mt-6 flex justify-center gap-3 md:justify-start">
                            ...
                            <button className="cursor-pointer rounded-lg border border-gray-300 px-6 py-3 font-medium text-gray-5000 transition hover:bg-[#1b4d61] hover:text-white">
                        ...
                        <div className="w-full px-4">
                            <div className="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                                ...
                                <ul className="mb-10 flex flex-wrap items-center justify-center gap-5">
                                    ...
                                    <li>
                                        <a
                                            href="https://github.com/themewagon/play-tailwind"
                                            target="_blank"
                        ...
                        <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                            <div className="wow fadeInUp group mb-12" data-wow-delay=".1s">
                                ...
                                <p className="text-body-color mb-8 lg:mb-9">
                                    Catat pemasukan dan pengeluaran harian dengan mudah, lengkap dengan kategori dan sumber transaksi secara otomatis.
                                </p>
                            ...
                            <div className="w-full px-4 lg:w-1/2">
                                <div className="mb-12 max-w-[540px] lg:mb-0">
                                    ...
                                    <p className="text-body-color mb-10 text-base leading-relaxed">
                                        ...
                                        dalam mengembangkan usahanya. Kami percaya bahwa setiap usaha, sekecil apapun, berhak mendapatkan kesempatan
                                        untuk tumbuh dan dikenal lebih luas.
                                        <br />
                                        <br />
            ...
            {/* Foto oleh <a href="https://unsplash.com/id/@blakewisz?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Blake Wisz</a> di <a href="https://unsplash.com/id/foto/dua-wanita-di-dekat-meja-GFrBMipOd_E?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
             */}
                    ...
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-4">
                            <div className="mx-auto mb-[60px] max-w-[510px] text-center">
                                ...
                                <p className="text-body-color text-base">
                                    Pilih paket terbaik sesuai kebutuhan bisnis Anda. Semua paket sudah termasuk fitur-fitur penting untuk mempermudah
                                    pengelolaan usaha.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="-mx-4 flex flex-wrap items-center lg:flex-row-reverse">
                            ...
                            <div className="w-full px-4 lg:w-1/2">
                                <div className="mb-12 max-w-[540px] lg:mb-0 lg:ml-auto">
                                    ...
                                    <p className="text-body-color mb-10 text-base leading-relaxed">
                                        Di balik EMKM, ada visi besar untuk membantu pelaku usaha kecil di seluruh Indonesia agar bisa naik kelas dan
                                        bersaing di era digital.
                                        <br />
                                        <br />
                                        Founder kami percaya bahwa setiap pengusaha lokal memiliki potensi luar biasa untuk berkembang asal diberikan
                                        akses pada alat, wawasan, dan dukungan yang tepat. EMKM lahir dari semangat itu, untuk menjadi mitra digital
                                        yang memudahkan UMKM dalam mengelola bisnis, memperluas jangkauan, dan meningkatkan daya saing.
                                        <br />
                                        <br />
            ...
            <section id="team" className="bg-gray-1 overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]">
                <div className="container mx-auto px-4">
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-4">
                        ...
                        <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
                            <div className="mb-10 w-full">
                                ...
                                <div className="-mx-3 flex items-center">
                                    <a href="javascript:void(0)" className="px-3 text-gray-500 hover:text-white">
                                        <svg
                                            width="22"
                                            height="22"
                                            viewBox="0 0 22 22"
