                        ...
                        <div className="-mx-4 flex flex-wrap">
                            <div className="w-full px-4">
                                <div className="mx-auto mb-[60px] max-w-[520px] text-center">
                                    ...
                                    <h2 className="text-dark mb-3 text-3xl leading-[1.2] font-bold sm:text-4xl md:text-[40px]">Punya Pertanyaan?</h2>
                                    <p className="text-body-color mx-auto max-w-[485px] text-base">
                    ...
                    <div className="relative container mx-auto px-4">
                        <div className="-mx-4 flex flex-wrap items-center">
                            <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
                                <div className="ud-contact-content-wrapper">
                                    <div className="ud-contact-title mb-12 lg:mb-[150px]">
                                        <span className="text-dark mb-6 block text-base font-medium">HUBUNGI KAMI</span>
                                        <h2 className="text-dark max-w-[260px] text-[35px] leading-[1.14] font-semibold">
                                    ...
                                    <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                                        <div className="mb-8 flex w-[330px] max-w-full">
                                            ...
                                            <div>
                                                <h5 className="text-dark mb-[18px] text-lg font-semibold">Lokasi Kami</h5>
                                                <p className="text-body-color text-base">
                                        ...
                                        <div className="mb-8 flex w-[330px] max-w-full">
                                            ...
                                            <div>
                                                <h5 className="text-dark mb-[18px] text-lg font-semibold">Butuh Bantuan atau Informasi?</h5>
                                                <p className="text-body-color text-base">webemkm@gmail.com</p>
                                                <a
                                                    href="https://emkm.web.id/"
                                                    className="text-base text-primary transition-colors duration-200 hover:text-blue-700 hover:underline"
                                                >
                                                    https://emkm.web.id/
                                                </a>
                                            </div>
                            ...
                            <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
                                <div
                                    className="wow fadeInUp shadow-testimonial -2 rounded-lg bg-white px-8 py-10 sm:px-10 sm:py-12 md:p-[60px] lg:p-10 lg:px-10 lg:py-12 2xl:p-[60px]"
                                    data-wow-delay=".2s."
                                >
                                    <h3 className="text-dark mb-8 text-2xl font-semibold md:text-[28px] md:leading-[1.42]">Kirim kami Pesan</h3>
                                    <form onSubmit={handleSubmit}>
                                        <div className="mb-[22px]">
                                            <label htmlFor="fullName" className="text-body-color mb-4 block text-sm">
                                                Nama Lengkap*
                                            </label>
                                            <input
                                                type="text"
                                                ...
                                                className="text-body-color placeholder:text-body-color/60 w-full border-0 border-b border-[#f1f1f1] bg-transparent pb-3 focus:border-primary focus:outline-hidden"
                                            />
                                        </div>
                                        <div className="mb-[22px]">
                                            <label htmlFor="email" className="text-body-color mb-4 block text-sm">
                                                Email*
                                            </label>
                                            <input
                                                type="email"
                                        ...
                                        <div className="mb-[22px]">
                                            <label htmlFor="phone" className="text-body-color mb-4 block text-sm">
                                                Nomor Telepon*
                                            </label>
                                            <input
                                                type="text"
                                        ...
                                        <div className="mb-[30px]">
                                            <label htmlFor="message" className="text-body-color mb-4 block text-sm">
                                                Pesan*
                                            </label>
                                            <textarea
                                                name="message"
                                                ...
                                                className="text-body-color placeholder:text-body-color/60 w-full resize-none border-0 border-b border-[#f1f1f1] bg-transparent pb-3 focus:border-primary focus:outline-hidden"
                                            ></textarea>
                                        </div>
                                        <div className="mb-0">
                                            <button
                ...
                <footer className="wow fadeInUp relative z-10 bg-[#090E34] pt-20 lg:pt-[100px]" data-wow-delay=".15s">
                    ...
                    <div>
                        ...
                        <span className="absolute right-0 bottom-0 z-[-1]">
                            <img src="/images/shape-3.svg" alt="" />
                        </span>
