...
export default function CreateNotification({ users }: Props) {
    ...
    const handleUserToggle = (userId: number, checked: boolean) => {
        if (checked) {
            ...
            setData('target_users', data.target_users.filter((id: number) => id !== userId));
        }
    };

    const handleSelectAll = (checked: boolean) => {
        if (checked) {
            setData('target_users', users.map(user => user.id));
        } else {
    ...
    return (
        <AppLayout>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                ...
                <HeadingSmall title="Buat Notifikasi" description="Form untuk membuat notifikasi baru" />
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex items-center space-x-2 mb-2">
                                    <Checkbox
                                        id="select-all"
                                        checked={data.target_users.length === users.length}
                                ...
                                <p className="text-sm text-gray-500">
                                    Jika tidak ada yang dipilih, notifikasi akan dikirim ke semua user.
                                </p>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                />
                                <p className="text-sm text-gray-500">
                                    Jika kosong, notifikasi akan dikirim segera.
                                </p>
